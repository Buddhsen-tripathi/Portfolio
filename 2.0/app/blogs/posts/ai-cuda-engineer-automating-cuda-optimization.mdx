...
excerpt: "Sakana AI's AI CUDA Engineer automates CUDA kernel optimization using LLMs, achieving up to 145x speedup over PyTorch. Learn how it works and its potential impact on high-performance computing."
date: "20-02-2025"
