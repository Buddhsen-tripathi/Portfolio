...
```
<img src="/blog-images/openaires.png" className="m-4" alt="OpenAI API response to a prompt" width="750" height="600" />
...
```
<img src="/blog-images/deepseekres.png" className="m-4" alt="DeepSeek API response to a prompt" width="750" height="600" />
