    ...
    return (
        ...
        text-xl items-center px-12 h-20'>
                ...
                <ul className='hidden md:flex gap-12 z-10 cursor-pointer'>
                    <li><Link to="about" offset={50} smooth="true" duration={500}>About</Link></li>
                    <li><Link to="projects" offset={50} smooth="true" duration={500}>Projects</Link></li>
                    <li><Link to="contact" offset={50} smooth="true" duration={500}>Contact</Link></li>
